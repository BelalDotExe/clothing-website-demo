...
@section('title', 'Categories - Chroma')
@section('body_class', 'aura')
@section('body_class', 'aura')
    ...
    <header class="aura-header">
        <div class="aura-container aura-header__inner">
            ...
            <div class="aura-actions">
                ...
                <a class="aura-icon-btn aura-cart" href="/cart" aria-label="View cart">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
@section('content')
    ...
    <section class="aura-container aura-main">
